...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">  
	<head>
		...
		<link href="LI.Web/css/letsintern.css" rel="stylesheet" type="text/css" />
		<script src="LI.Web/scripts/jquery-1.5.1.js"></script>
		<script src="LI.Web/scripts/jquery.ui.core.js"></script>
		<script src="LI.Web/scripts/jquery.ui.widget.js"></script>
		<script src="LI.Web/scripts/jquery.ui.datepicker.js"></script>
		<script> 
			$(function() {
		...
		<link rel="stylesheet" href="LI.Web/css/validationEngine.jquery.css" type="text/css"/>
		<!--<link rel="stylesheet" href="css/template.css" type="text/css"/>-->
		<script src="LI.Web/scripts/jquery-1.7.2.min.js" type="text/javascript">
		</script>
		<script src="LI.Web/scripts/languages/jquery.validationEngine-en.js" type="text/javascript" charset="utf-8">
		</script>
		<script src="LI.Web/scripts/jquery.validationEngine.js" type="text/javascript" charset="utf-8">
		</script>
	<script>
...
<table cellspacing="0" cellpadding="0" class="outerlogin" align="center">
  <tr>
    <td>
      ...
      <form id="formID" class="formular" method="post" action="LI.Web/Student/PageList.php">
