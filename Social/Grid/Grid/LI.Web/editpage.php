    ...
    <body>            
        ...
        <div>
            <form name="Question" method="post">
                <table>
                    <tr><td><?php echo $_GET["qid"];?></td></tr>
                    <tr><td><?php echo $_GET["uid"];?></td></tr>
                    <tr>
                        <td>Functions</td>
                        <td>
                            <?php
                    ...
                    <tr><td><input type="radio" name="QuestionType" value="Audio Response" />Audio Response</td></tr>        
        ...
        if($_POST["update"]=="Update")
        {
            try {
                    ...
                    $objQuestion->CreatedByUserId = $_GET["uid"];
                    ...
                    if($objQuestion->QuestionType=="MCQ")
                    {
                        ...
                        $objQuestionManagemenet->UpdateQuestion($objQuestion,$objQuestionOptionsArray,$QuestionId);
                    }
                    else if($objQuestion->QuestionType=="T/F")
                    {
                        ...
                        $objQuestionManagemenet->UpdateQuestion($objQuestion,$answer,$QuestionId);
                    }
                    else
                    {
                        $answer="";
