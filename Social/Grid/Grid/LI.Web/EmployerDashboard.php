    ...
    <div class="span2">
      ...
      <div class="sidebar-nav">
        ...
        <ul class="nav nav-list"> 
          ...
          <li id="sideLabel1" class="active"><a href="#" id="dashboardSideNav" onclick="callFrame('EmployerDashboardInner.php','sideLabel1')"><i class="icon-home"></i> Dashboard</a></li>
          <li id="sideLabel2"><a href="#"><i class="icon-edit"></i> Reports</a></li>
          <li id="sideLabel3"><a href="#"><i class="icon-user"></i> Account Settings</a></li>
          ...
          <li id="sideLabel4"><a href="#" id="postJobSideNav"onclick="callFrame('JobPostingForm.php','sideLabel4')"><i class="icon-edit"></i>Post Job</a></li>
                    <li><a href="#"><i class="icon-certificate"></i>Manage Jobs</a></li>

          <li id="sideLabel5"><a href="#"><i class="icon-briefcase"></i>Screening Tool</a></li>
          <li id="sideLabel6"><a href="#"><i class="icon-barcode"></i>Question Bank</a></li>

          <li class="nav-header">Manage My Interns</li>
          <li id="sideLabel7"><a class="cookie-delete" href="#"><i class="icon-wrench"></i> Current Interns</a></li>
          <li id="sideLabel8"><a class="sidenav-style-1" href="#"><i class="icon-align-left"></i>Prior Interns</a></li>
          <li id="sideLabel9"><a class="sidenav-style-2" href="#"><i class="icon-align-right"></i>Recommend</a></li>
