...
<body>
  ...
  <?
  	if(!isset($_POST["jobID"])){
		echo "Oops.. You seem to be lost. Please follow this link which will take you to where you belong. <link to public url of letsintern.com>";
		die;
	}
	else{
		$jobId = $_POST["jobID"];
		//Code for button
		//<form method='post' action='EditJob.php'><input type='hidden' name="jobID" value='$jobId'/><button type="submit"></button></form>
		$objJobManagement = new JobManagement();
		$objJobCard = $objJobManagement->GetJobDetailsByJobId1($jobId);
		foreach($objJobCard as $tempJobCard){}		
	}
  ?>
  
    <h1 class="offset6">Edit Job</h1>
    			...
    			<div class="span4">     
                      ...
                      <div class="control-group">
                          ...
                          <div class="controls">Job Type
                              ...
                              echo Utilities::GetHTMLDropdownWithSelected($list,"JobTypeId",$tempJobCard['JobTypeId']);
                              ?>
                          </div>
                      </div>                      
                      <div class="control-group">
                          ...
                          <div class="controls">Job Title
                              <input type="text" name="Title" required="required" id="inputTitle" value=<? echo "'".$tempJobCard['Title']."'"; ?>  data-minlength="5" maxlength="100" required="required"/>
                          </div>
                      </div>
                      <div class="control-group">
                          
                          <div class="controls">Job Description
                              <textarea rows="5" id="description" required="required" name="Description" required="required"><? echo $tempJobCard['Description']; ?></textarea>
                          </div>
                      </div>
                      <div class="control-group">
                          ...
                          <div class="controls">Location
                              ...
                              echo Utilities::GetHTMLMultipleListWithSelected($list,"LocationName",$tempJobCard['LocationIdString']);
                              ?>
                          </div>
                      </div>                      
                      <div class="control-group">
                          ...
                          <div class="controls">Starts<br/>
                              <input type="text" id="datepicker1" name="StartDate" value=<? echo "'".$tempJobCard['StartDate']."'"; ?> required="required">
                          </div>                          
                      </div>
                      ...
                      <div class="control-group">
                          ...
                          <div class="controls">Ends<br/>
                              <input type="text" id="datepicker2" name="EndDate" value=<? echo "'".$tempJobCard['EndDate']."'"; ?> required="required">
                          </div>                          
                      </div>
                      <div class="control-group">
                          <label class="checkbox inline">
                              <div class="controls">
                                ...
                                <input type ="checkbox" name="IsPeriodFlexible" <?if ($tempJobCard['isPeriodFlexible'] == "1"){echo "checked='yes'";} ?> > Period is flexible(<i class="icon-ok"></i>)
                              </div>
                          </label>
                      </div>
               </div>
                     ...
                     <div class="control-group">
                      ...
                      <div class="control-group">
                          ...
                          <div class="controls">
                              <select id="jobSubCategory" name="SubCategoryId" required="required">
                              	<?
                              		$list1 = $objJobManagement->GetJobSubCategoryListByCategoryId($tempJobCard['CategoryId']);
									$string="";
            						foreach($list1 as $id1 => $param_value1)
						            {
						            	if($tempJobCard['SubCategoryId'] == $id1){
                      ...
                      <div class="control-group">
                          ...
                          <div class="controls">Required Skill Set
                              ...
                              echo Utilities::GetHTMLMultipleListWithSelected($list,"Skill",$tempJobCard['RequiredSkillIdString']);
                              ?>
                          </div>
                      </div> 
                      <div class="control-group">
              ...
              <div class = "span8" >              
                      ...
                      <div class="control-group">
                          ...
                          <div class="controls">Renumeration<br/>
                              <input type="text" name="Amount" required="required" pattern="^[0-9]+" id="inputAmount" value=<? echo "'".$tempJobCard['Amount']."'"; ?> required="required" />
                          </div>
                      </div>
                      <div class="control-group">
                          <label class="checkbox inline">
                              <div class="controls">
                                <input type ="checkbox" name="JobProspect" <?if ($tempJobCard['JobProspect'] == "1"){echo "checked='yes'";} ?>> Converts to full time Job(<i class="icon-ok"></i>)
                              </div>
                          </label>
                      </div>
                      <div class="control-group">
                          ...
                          <div class="controls">Number of Positions<br/>
                              <input type="text" required="required" pattern="^[0-9]+"  name="NoOfPositions" id="NoOfPositions" value=<? echo "'".$tempJobCard['NoOfPositions']."'"; ?> required="required" />
                          </div>
                      </div>
                      <div class="control-group">
                          
                          <div class="controls">Application Deadline<br/>
                              <input type="text" id="datepicker3" name="ApplicationDeadline" value=<? echo "'".$tempJobCard['ApplicationDeadline']."'"; ?> required="required">
                          </div>                          
                      </div>
                      <div class="control-group">
                          <div class="controls">
								<input type="hidden" name="jobID" value = '<?echo $jobId; ?>' >                                
        ...
        if(isset($_POST["Title"]))
        {
            try 
                {   
                    ...
                    $objJob->EmployerId=$tempJobCard['EmployerId'];  //will be getting in session handling
                    ...
                    //insert
                    $objJobManagement->EditJob($objJob); 
                }
                catch(Exception $ex){
                    echo $ex->getMessage();
                    die;        
